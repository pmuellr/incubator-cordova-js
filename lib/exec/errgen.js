...
function init() {
    ...
    overrides["Network Status::getConnectionInfo"] = Network_Status__getConnectionInfo
    overrides["Accelerometer::setTimeout"]         = Accelerometer__setTimeout
    overrides["Accelerometer::getTimeout"]         = Accelerometer__getTimeout
}
...
//------------------------------------------------------------------------------
function Accelerometer__setTimeout(success, fail, args) {
    setTimeout(function() { 
...
//------------------------------------------------------------------------------
function Accelerometer__getTimeout(success, fail, args) {
    setTimeout(function() { 
...
//------------------------------------------------------------------------------
function Network_Status__getConnectionInfo(success, fail) {
    setTimeout(function() { 
        success("none") 
    }, 10)
}
